...
# invocar con ./01_clonar_versionLGS.sh NuevoCliente
...
nombre_file="/home/oracle/datapum/lgs_dumpv1.dmp"
...
/u01/app/oracle/product/11.2.0/dbhome_1/bin/expdp system/Ch1r1m0y0_Pl4y3r0 schemas=registro_lgs directory=copias dumpfile=lgs_dumpv1.dmp logfile=lgsexpv1.log
fi
...
/u01/app/oracle/product/11.2.0/dbhome_1/bin/impdp system/Ch1r1m0y0_Pl4y3r0 schemas=registro_lgs directory=copias dumpfile=lgs_dumpv1.dmp logfile=lgsimpv1.log  remap_schema=registro_lgs:$nuevo_usuario
